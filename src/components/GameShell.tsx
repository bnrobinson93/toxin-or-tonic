...
const THEMES = ["meadow", "forest", "midnight"] as const;
...
export default function GameShell({ children }: { children: React.ReactNode }) {
  ...
  // Ensure theme persists after auth state changes
  useEffect(() => {
    const applyTheme = () => {
      try {
        ...
        const theme = THEMES.includes(stored) ? stored : "meadow";
    ...
    // Also apply after a short delay to catch any Clerk redirects
